...
export const themeConfig = {
  ...
  navMore: [
    ...
    },
    {
      ...
      list: [
        {
          icon: "/images/svg/github2-128.svg",
          name: "Curve | Blog",
    ...
    sitemap: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "DouYin", link: "https://github.com/imsyy/SPlayer/", newTab: true },
          { text: "Hot", link: "https://github.com/imsyy/DailyHotApi/", newTab: true },
          { text: "HuaSen", link: "https://github.com/imsyy/Snavigation/", newTab: true },
        ],
      },
      // {
      //   text: "项目",
